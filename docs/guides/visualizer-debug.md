...
ffmpeg -f gdigrab -framerate 30 -i desktop `
  ...
  -t 10 `
  packages/frontend/tests/browser/out/visualizer_capture.mp4
```

### Extract frames
```powershell
# 1fps extraction to numbered PNGs
$framesDir = "packages/frontend/tests/browser/out/visualizer_frames"
New-Item -ItemType Directory -Force -Path $framesDir | Out-Null
ffmpeg -i packages/frontend/tests/browser/out/visualizer_capture.mp4 `
...
const FRAMES_DIR = 'packages/frontend/tests/browser/out/visualizer_frames';
