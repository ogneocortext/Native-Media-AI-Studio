  ...
  const createMeshForObject = useCallback(
    async (obj: any, THREE: any) => {
      ...
      if (obj.type === "crown") {
        ...
        // Any object with modelUrl loads GLB (blend->glb pipeline: stage.blend -> stage.glb)
        // Keeps AI agent flow: blender_execute_blender_code -> convert_blend_to_glb.py -> /models/blends/*.glb -> Three.js
